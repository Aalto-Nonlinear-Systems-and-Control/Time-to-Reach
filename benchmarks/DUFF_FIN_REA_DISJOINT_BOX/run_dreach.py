...
# =============================================================================
DRH_FILENAME = (
    "duffing_fin_rea_disjoint_box.drh"  # Change this for different benchmarks
)
BENCHMARK_NAME = "DUFF_FIN_REA_DISJOINT_BOX"  # Change this for different benchmarks
SETTING_NAME = "setting_0"  # Change this for different settings
DOCKER_IMAGE = "dreach:latest"  # Docker image name
TIMEOUT_SECONDS = 600  # Timeout for verification (10 minutes)
# =============================================================================
