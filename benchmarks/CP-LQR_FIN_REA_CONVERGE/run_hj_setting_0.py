...
def main():
    """Main function to run HJ_Reachability analysis for benchmark_CP_LQR_REA_CONVERGE."""
    ...
    grid_size = 100
    accuracy = "low"  # HJ solver accuracy: "low", "medium", "high", "very_high"
    ...
    try:
        print("=" * 60)
        print("HJ_Reachability Analysis - benchmark_CP_LQR_REA_CONVERGE")
        print("=" * 60)
