...
# =============================================================================
DRH_FILENAME = "cp_lqr_fin_rea_converge.drh"  # Change this for different benchmarks
BENCHMARK_NAME = "CP_LQR_FIN_REA_CONVERGE"  # Change this for different benchmarks
