%% CORA Reachability Analysis - Setting: default_nonlinear
% This script runs a single CORA reachability analysis on the CP-LQR 4D nonlinear control system.
...
setting.alg = 'lin'; % Linearization approach for nonlinear systems
setting.taylorTerms = 3;
setting.zonotopeOrder = 50;
setting.timeStep = 0.05; % Larger time step for longer horizon (8s)
...
fprintf('System: 4D CP-LQR Nonlinear Control System\n');
fprintf('Initial point: [0.8, 0.3, -π/4, 0.2]\n');
fprintf('Target: Origin ±0.01\n');
fprintf('Time horizon: 8 seconds\n');
tic;
