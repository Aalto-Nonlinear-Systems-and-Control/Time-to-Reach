...
# =============================================================================
DRH_FILENAME = "mas_con_fin_unr_safe_0.drh"  # Change this for different benchmarks
BENCHMARK_NAME = "MAS_CON_FIN_UNR_SAFE_0"  # Change this for different benchmarks
SETTING_NAME = "setting_0"  # Change this for different settings
DOCKER_IMAGE = "dreach:latest"  # Docker image name
TIMEOUT_SECONDS = (
    1800  # Timeout for verification (30 minutes) - increased for 16D system
)
# =============================================================================
