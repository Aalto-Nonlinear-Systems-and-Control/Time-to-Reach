...
# =============================================================================
DRH_FILENAME = "mas_con_fin_unr_safe_1.drh"  # Change this for different benchmarks
BENCHMARK_NAME = "MAS_CON_FIN_UNR_SAFE_1"  # Change this for different benchmarks
