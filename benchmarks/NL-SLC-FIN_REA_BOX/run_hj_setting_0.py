...
def main():
    """Main function to run HJ_Reachability analysis for benchmark_NL_SLC_FIN_REA_BOX."""
    # Set parameters directly
    config_file = "../../configs/benchmark_NL_SLC_FIN_REA_BOX.json"
    ...
    try:
        print("=" * 60)
        print("HJ_Reachability Analysis - benchmark_DUFF_FIN_REA_BALL")
        print("=" * 60)
